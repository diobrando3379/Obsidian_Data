...
function main(config) {
  ...
  config["proxy-groups"] = [
    ...
    },
    {
      ...
      "name": "电报消息",
      "type": "select",
      "proxies": ["日用低倍率节点", "节点选择", "延迟选优", "故障转移", "负载均衡(散列)", "负载均衡(轮询)", "全局直连"],
      "include-all": true,
    ...
    },
    {
      ...
      "name": "微软服务",
      "type": "select",
      "proxies": ["DIRECT", "日用低倍率节点", "全局直连", "节点选择", "延迟选优", "故障转移", "负载均衡(散列)", "负载均衡(轮询)"],
      "include-all": true,
    ...
    },
    {
      ...
      "name": "苹果服务",
      "type": "select",
      "proxies": ["DIRECT", "日用低倍率节点", "节点选择", "延迟选优", "故障转移", "负载均衡(散列)", "负载均衡(轮询)", "全局直连"],
      "include-all": true,
